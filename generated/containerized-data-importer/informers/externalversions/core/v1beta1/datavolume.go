	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CdiV1beta1().DataVolumes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CdiV1beta1().DataVolumes(namespace).Watch(context.TODO(), options)
			},
		},
		&corev1beta1.DataVolume{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dataVolumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&corev1beta1.DataVolume{}, f.defaultInformer)
}

func (f *dataVolumeInformer) Lister() v1beta1.DataVolumeLister {
	return v1beta1.NewDataVolumeLister(f.Informer().GetIndexer())
}
